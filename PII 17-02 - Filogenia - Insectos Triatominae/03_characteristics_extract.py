#Sistema semiautomático para la extracción de las características morfológicas de los insectos vectores
...
class Get_Characteristics: 
	...
	def get_csv_characteristics():
		...
		#Definición de un Dataset que contiene la información de los n-gramas ordenados por nombre
		...
		#Condicionar resultados mediante la Regla de Paretto
